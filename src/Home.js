    ...
    return (
      <Jumbotron fluid>
        <Container fluid className='center-everything'>
          ...
          <div className="lead">
            I'm a rising junior at the University of Illinois at Urbana-Champaign studying computer science.
          </div>
          <div className="lead">
            I also study math as a second major and pursue any new technologies that interest me, like ReactJS (used for this site).
          </div>
          <div className="lead">
